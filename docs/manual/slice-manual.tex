...
Fonts you have sliced are offered again on the next visit, under \textbf{Opened before}, with the settings you last used on them. Choosing one is not ``open that file again'' --- the font and its settings come back together, which for a job you repeat is two clicks instead of a file dialogue and five fields.
