...
\begin{itemize}
  ...
  \item \textbf{\href{https://felipesanches.github.io/slice-web/real-world-sweep.html}{The real-world sweep}} --- what happens on 775 real variable fonts from Google Fonts: 133,483 glyphs compared against fontTools with no disagreements.
